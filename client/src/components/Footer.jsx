...
function Footer() {
  ...
  return (
    <footer className={`${
        ...
        "hidden"
      }  w-full text-gray-700 bg-gray-100 body-font`}>
      <div className="container flex flex-col flex-wrap px-3 py-10 mx-auto md:items-center lg:items-start md:flex-row md:flex-nowrap">
        <div className="flex-shrink-0 w-64 mx-auto text-center md:mx-0 md:text-left">
          <Link to="/" className="flex items-center justify-center font-bold text-3xl title-font md:justify-start">
            <img src="/picprismlogo.png" className="w-[70px]" alt="Pic-Galaxy Logo" />
            Pic-Galaxy
          </Link>
        ...
        <div className="flex flex-wrap flex-grow mt-10 -mb-10 text-center md:pl-20 md:mt-0 md:text-left">
          ...
          <div className="w-full px-4 lg:w-1/4 md:w-1/2">
            ...
            <nav className="mb-10 list-none">
              ...
              <li className="mt-3">
                <a href="tel:+919876543210" className="text-gray-500 cursor-pointer hover:text-gray-900">+91-9876543210</a>
              </li>
            </nav>
          </div>
        </div>
